...
(function(b){
    b.fn.lightBox=function(a){
        function o(){
            ...
            c.onload=function(){
                ...
                //c.width>a.maxImageWidth&&b("#lightbox-image").width(a.maxImageWidth);
                //p(b("#lightbox-image").width(),b("#lightbox-image").height());
                p(c.width,b("#lightbox-image").height());
                c.onload=function(){}
            };
        ...
        b("#lightbox-nav-btnPrev,#lightbox-nav-btnNext").css({
            height:d+a.containerBorderSize*2
            })
        }
        function q(){
        ...
        b("#lightbox-image").fadeIn(function(){
            ...
            a.imageArray.length>1&&b("#lightbox-image-details-currentNumber").html(a.txtImage+" "+(a.activeImage+1)+" "+a.txtOf+" "+a.imageArray.length).show();
            r()
            });
    ...
    if(a.activeImage!=0)a.fixedNavigation?b("#lightbox-nav-btnPrev").css({
    ...
    if(a.activeImage!=a.imageArray.length-1)a.fixedNavigation?b("#lightbox-nav-btnNext").css({
...
function i(){
    ...
    if(self.innerHeight){
        ...
        pageHeight=d<f?f:d;
    pageWidth=c<e?c:e;
    return arrayPageSize=Array(pageWidth,pageHeight,e,f)
    }
    function k(){
    var c,d;
    if(self.pageYOffset){
        ...
        return arrayPageScroll=Array(c,d)
    }
    function n(c){
    var d=new Date;
...
return this.unbind("click").click(function(){
    ...
    a.activeImage=0;
    if(h.length==1)a.imageArray.push(Array(this.getAttribute("href"),this.getAttribute("title")));else for(var c=0;c<h.length;c++)a.imageArray.push(Array(h[c].getAttribute("href"),h[c].getAttribute("title")));
