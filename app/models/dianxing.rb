...
class Dianxing < Hejia::Db::Hejia
  def dianxing_keywords
    kws = []
    kws << self.pd_daohang1.split(" ").first unless self.pd_daohang1.blank?
    kws << self.pd_daohang2.split(" ").first unless self.pd_daohang2.blank?
    kws << self.pd_daohang3.split(" ").first unless self.pd_daohang3.blank?
    kws << self.pd_daohang4.split(" ").first unless self.pd_daohang4.blank?
    kws << self.pd_daohang5.split(" ").first unless self.pd_daohang5.blank?
    kws << self.pd_daohang6.split(" ").first unless self.pd_daohang6.blank?
    kws
  end
end
